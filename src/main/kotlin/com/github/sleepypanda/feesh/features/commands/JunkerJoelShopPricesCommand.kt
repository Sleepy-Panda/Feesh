...
object JunkerJoelShopPricesCommand {
    ...
    private fun calculateJunkerJoelShopPrices() {
        try {
            ...
            ChatUtils.sendLocalChat("${DARK_GRAY}Profits for selling shop items compared with selling Rusty Coins, Busted Belt Buckles, Old Leather Boots as is. Prices mode: ${WHITE}$modeText.\n")

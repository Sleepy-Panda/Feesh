...
object PlayerDeathAlert {
    val YOU_DIED_PATTERN = Regex("^ ☠ You were killed by (Ragnarok|Thunder|Lord Jawbus|Jawbus Follower|Wiki Tiki|Wiki Tiki Laser Totem|Titanoboa|Nessie|Silkbreeze|Giant Isopod)\\.$")

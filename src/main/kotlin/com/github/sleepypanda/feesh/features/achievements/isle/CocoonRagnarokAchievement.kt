...
object CocoonRagnarokAchievement : BaseAchievement(
    id = "cocoon_ragnarok",
    displayName = "Ragnarok - Are you dead yet?",
    description = "Cocoon a Ragnarok.",
    ...
    private fun onSeaCreatureCocooned(event: SeaCreatureCocoonedByYouEvent) {
        CommonUtils.runWithCatching("Failed to check and handle achievement $id") {
            ...
            if (!event.seaCreatureName.equals(SeaCreatureNames.RAGNAROK, ignoreCase = true)) return@runWithCatching

...
object RareMobHighlight {
    ...
    private fun onArmorStandDetailsLoaded(event: ArmorStandDetailsLoadedEvent) {
        ...
        val mobEntityShift = when (cleanName) {
            HighlightableSeaCreatureTypes.DROWNED_CAPTAIN.displayName -> 6 // Captain entity shifted from its armor stand
            HighlightableSeaCreatureTypes.PUDDLE_JUMPER.displayName -> 2 // Puddle Jumper entity shifted from its armor stand

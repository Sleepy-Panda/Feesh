...
class RareDrops {
    companion object {
        ...
        val rareDrops = listOf(
            ...
            RareDropInfo(RareDropTypes.LEGENDARY_SQUID_PET.displayName, "SQUID;4", LEGENDARY.code, false),
            RareDropInfo(RareDropTypes.EPIC_SQUID_PET.displayName, "SQUID;3", EPIC.code, false),
            RareDropInfo(RareDropTypes.RARE_SQUID_PET.displayName, "SQUID;2", RARE.code, false),
            RareDropInfo(RareDropTypes.UNCOMMON_SQUID_PET.displayName, "SQUID;1", UNCOMMON.code, false),
            RareDropInfo(RareDropTypes.COMMON_SQUID_PET.displayName, "SQUID;0", COMMON.code, false),
